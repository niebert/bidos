  ...
  function bxDashboard() {
    ...
    function controllerFn($rootScope, $scope, UserFactory, $state, $window, Resources, $mdToast, $mdDialog) {
      ...
      vm.tiles.b = [{
        ...
        onClick: function() {
          return $state.go('bidos.observation-inbox');
        },
        colSpan: [0, 0, 2],
        rowSpan: [0, 0, 0]
      }, {
      ...
      vm.tiles.c = [ {
        ...
        roles: ['admin', 'practitioner'],
        onClick: function() {
          return $state.go('bidos.portfolio');
        },
        colSpan: [0, 2, 0],
        rowSpan: [0, 0, 0]
      }*/];
