(function() {
  ...
  function ResourceService($rootScope, $q, Help, Cache, Outbox, CRUD) {
      ...
      return $q(function(resolve, reject) {
        if ($rootScope.online) {
          CRUD.create(resource).then(function(response) {
            resolve(response);
            Help.log('resource service: successfully created resource', response);
          }).catch(function(err) {
            reject(err);
    ...
    function updateResource(resource) {
      return $q(function(resolve, reject) {
        if ($rootScope.online) {
          CRUD.update(resource).then(function(response) {
            resolve(response);
            Help.log('resource service: successfully updated resource', response);
          }).catch(function(err) {
            reject(err);
    ...
    function destroyResource(resource) {
      return $q(function(resolve, reject) {
        if ($rootScope.online) {
          CRUD.destroy(resource).then(function(response) {
            resolve(response);
