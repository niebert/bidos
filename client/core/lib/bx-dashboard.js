(function() {
  ...
  function bxDashboard() {
    return {
      ...
      controllerAs: 'vm',
      templateUrl: 'core/templates/bx-dashboard.html'
    };
      ...
      vm.menu = [
        {
          ...
          onClick: function() { return $state.go('bx.user-preferences') },
        ...
        },
        {
          ...
          roles: ['admin', 'practitioner', 'scientist'],
          onClick: function() { return $state.go('bx.user-profile') },
          colSpan: [0, 0, 0]
        },
        {
          ...
          onClick: function() { return $state.go('bx.capture', {type: 'kid'}) },
          colSpan: [2, 0, 0]
        },
        {
          ...
          description: '',
          roles: ['admin', 'practitioner'],
          onClick: function() { return $state.go('bx.portfolio') },
          colSpan: [0, 0, 0]
        },
        {
          ...
          description: '',
          roles: ['admin', 'practitioner'],
          onClick: function() { return $state.go('bx.table', {type: 'observation'}); },
          colSpan: [0, 0, 0]
        },

        {
          ...
          onClick: function() { return $state.go('bx.observation-inbox') },
          colSpan: [0, 0, 0]
        },
        {
          shortText: 'Kinder',
          ...
          description: '',
          roles: ['admin', 'practitioner'],
          onClick: function() { return $state.go('bx.table', {type: 'kid'}); },
          colSpan: [0, 0, 0]
        },
        {
          shortText: 'Gruppen',
          ...
          description: '',
          roles: ['admin', 'practitioner'],
          onClick: function() { return $state.go('bx.table', {type: 'group'}); },
          colSpan: [0, 0, 0]
        },
        {
          shortText: 'Benutzer',
          ...
          description: '',
          roles: ['admin', 'practitioner'],
          onClick: function() { return $state.go('bx.table', {type: 'user'}); },
          colSpan: [0, 0, 0]
        },
        {
          shortText: 'Bausteine',
          ...
          description: '',
          roles: ['admin', 'scientist'],
          onClick: function() { return $state.go('bx.table', {type: 'item'}); },
          colSpan: [0, 0, 0]
        },
        {
          ...
          description: '',
          roles: ['admin', 'practitioner'],
          onClick: function() { return $state.go('bx.table', {type: 'institution'}); },
          colSpan: [0, 0, 0]
        }
      ];
